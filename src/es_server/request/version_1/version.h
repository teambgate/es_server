...
void es_server_process_get_v1(struct es_server *p, int fd, u32 mask, struct smart_object *obj);
void es_server_process_post_v1(struct es_server *p, int fd, u32 mask, struct smart_object *obj);
void es_server_process_put_v1(struct es_server *p, int fd, u32 mask, struct smart_object *obj);
