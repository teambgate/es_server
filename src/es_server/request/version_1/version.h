...
void es_server_process_post_v1(struct es_server *p, int fd, struct smart_object *obj);
void es_server_process_put_v1(struct es_server *p, int fd, struct smart_object *obj);
